...
--select customer_number from (select customer_number, count(*) from orders group by customer_number order by count(*) desc) where rownum = 1;
...
-- #585 - Investments in 2016 - sum of all total investment values in 2016 (TIV_2016). Condition 1 - Have the same TIV_2015 value as one or more other policyholders. 2 - Not located in the same city as any other policyholder 
with insurance as (
...
-- #1225 - Report Contiguous Death
-- #1336 - Number of transactions per visit
-- #1369 - Get the second most recent activity
-- #1384 - Total Sales Amount by Year
-- #1412 - Find the Quiet Student in All Exam
-- #1479 - Sales by day of the week
-- #1635 - Hopper Company Queries I
-- #1645 - Hopper Company Queries II
-- #1651 - Hopper Company Queries III
-- #1767 - Find the subtask that did not execute
